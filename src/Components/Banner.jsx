                    ...
                    <div className=" flex justify-center items-center gap-10 ">
                        <div className=" flex-1 px-5  space-y-7 text-blue-50">
                            <div className=" block lg:hidden">
                                ...
                                <Image src={"https://i.ibb.co/zN1tdxh/329792464-534173148815054-3736500652022655929-n.png"} width={200} height={200} alt="banner_images" />
                                <Image src={"https://i.ibb.co/RzJfVrc/326429760-565901131866976-8960223839941330956-n.png"} width={200} height={200} alt="banner_images" />
                                <Image src={"https://i.ibb.co/rZBdLHM/318567080-617695970110803-5923371384204745052-n.png"} width={200} height={200} alt="banner_images" />
                        ...
                        <div className=" hidden lg:block flex-1 space-y-5">
                            <div className=" space-y-0">
                                <Image src={"https://i.ibb.co/zN1tdxh/329792464-534173148815054-3736500652022655929-n.png"} height={200} width={200} alt="banner" />
                                <Image src={"https://i.ibb.co/RzJfVrc/326429760-565901131866976-8960223839941330956-n.png"} height={200} width={200} alt="banner" />
                                <Image src={"https://i.ibb.co/rZBdLHM/318567080-617695970110803-5923371384204745052-n.png"} height={200} width={200} alt="banner" />
                                {/* <img src="https://i.ibb.co/zN1tdxh/329792464-534173148815054-3736500652022655929-n.png" alt="" />
                            ...
                            <div>
                                <Image src={"https://i.ibb.co/dthzjcR/327063196-5800887573364035-3294745791563659576-n.png"} height={200} width={200} alt="banner" />
                                <Image src={"https://i.ibb.co/HxDdYYp/327713084-566495871797259-1779906837439389762-n-1.png"} height={200} width={200} alt="banner" />
                                <Image src={"https://i.ibb.co/1dVxhwy/323914620-1571722909934742-4947035793330347072-n.png"} height={200} width={200} alt="banner" />
