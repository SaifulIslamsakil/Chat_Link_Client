...
const Footer = () => {
    return (
        <footer className="  bg-black  text-blue-50 space-y-5 ">
            <div className="footer grid grid-cols-5 gap-10 lg:gap-0 p-10 w-[90%] mx-auto ">
                <div className=" space-y-10 col-span-5 lg:col-span-1">
                ...
                <nav className=" col-span-2 lg:col-span-1 ">
                    <header className="footer-title">What we do</header>
                ...
                <nav className=" col-span-2 lg:col-span-1">
                    ...
                    <a className="link link-hover">Brand Center</a>
                    <a className="link link-hover">  Privacy</a>
                </nav>
                <nav className=" col-span-2 lg:col-span-1">
                    <header className="footer-title"> Use MyChat</header>
                    <a className="link link-hover">Android</a>
                    <a className="link link-hover">iPhone</a>
                    <a className="link link-hover"> Mac/PC</a>
                    <a className="link link-hover"> WhatsApp Web</a>
                </nav>
                <nav className=" col-span-2 lg:col-span-1">
                    <header className="footer-title"> Need help?</header>
                    <a className="link link-hover">  Contact Us</a>
                    <a className="link link-hover">Help Center</a>
                    <a className="link link-hover">Download</a>
                    <a className="link link-hover"> Security Advisories</a>
                </nav>
            </div>
            <div className="footer items-center text-neutral-content px-10 py-3 w-[90%] mx-autonpmm ">
