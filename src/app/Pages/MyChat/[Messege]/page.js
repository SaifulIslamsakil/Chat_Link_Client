    ...
    return (
        <div className=' h-screen'>
            ...
            <div className=' border-t shadow-lg p-5 w-full flex items-center justify-between gap-2 '>
                ...
                <input type='text' placeholder='Type messege' className='p-2 text-xl w-3/4 bg-slate-200 outline-none rounded-lg' />
                <p className=' text-xl bg-green-50 p-3 rounded-lg'><BsFillSendFill /></p>
